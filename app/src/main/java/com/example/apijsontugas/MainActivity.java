package com.example.apijsontugas;
...
public class MainActivity extends AppCompatActivity {
    ArrayList<Data> pemrogramen = new ArrayList();
    ...
    private AdapterView.OnItemClickListener onItemClick = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            Data fSELECTED = pemrogramen.get(position);
    ...
    void refresResponView() {
        ...
        while(key.hasNext()) {
            ...
            try {
                ...
                pemrogramen.add(new Data(algoritma, baca_lebih_lanjut, heloWord, deskripsi, logo));
